...
class ZhengxinBasePage(BasePage):
    ...
    # approver_loc = (By.XPATH, "//span[text()='审核中']/../following-sibling::td[1]")

    # def click_zhengxinhao(self, zhengxinno):
    #     zhengxinno_loc = (By.XPATH, "//a[text()='" + zhengxinno + "']")
    #     self.find_element(*zhengxinno_loc).click()
    #
    # def get_approver(self):
    #     title_value = self.find_element(*self.approver_loc).get_attribute("title")
    #     return title_value.split(" ", 1)[0].split("-")[-1]
